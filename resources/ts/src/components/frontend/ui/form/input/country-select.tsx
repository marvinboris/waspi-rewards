                        ...
                        {selected && <div className='flex items-center'>
                            <div className='mr-[5.55px]'>
                                <div className="w-[19.42px] h-[19.42px]">
                                    {selected.code && <img src={`/images/flags/1x1/${selected.country.toLowerCase()}.svg`} alt="Flag" className="rounded-full" />}
                                </div>
                            </div>
                                    ...
                                    {({ selected }) => (
                                        <>
                                            <div className="flex items-center">
                                                <div className='mr-[5.55px]'>
                                                    <div className="w-[19.42px] h-[19.42px]">
                                                        {country.code && <img src={`/images/flags/1x1/${country.country.toLowerCase()}.svg`} alt="Flag" className="rounded-full" />}
                                                    </div>
                                                </div>
